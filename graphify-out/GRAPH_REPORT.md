...
## Corpus Check
- 930 files · ~457,986 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2553 nodes · 2908 edges · 681 communities (582 shown, 99 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 142 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02ae51a3`
...
6. `waitForAuthReady()` - 20 edges
7. `ensureTestArticleFixtures()` - 18 edges
...
## Communities (681 total, 99 thin omitted)
...
Cohesion: 0.19
Nodes (5): ContentBackLink(), PanelFrame(), PostDetailToolbar(), useChatSearchParams(), CloneActionsProvider()
...
Cohesion: 0.19
Nodes (4): PageSectionHeader(), SwitchVariants(), SwitchView(), SwitchPage()
...
Cohesion: 0.46
Nodes (4): DesktopWorkspace(), useContentPanelController(), useInteractionPanelController(), useResizeHandleExpand()
...
- **Why does `useChatSearchParams()` connect `Waitlist Mutations` to `Email Send Actions (transport)`, `Rick Rubin Seed Mutations`, `Mutation Test Suites`, `System Prompt Helper Tests`, `Community 92`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `WorkspaceToolbar()` connect `Inline Image Policy & Constants` to `Body Walk & Ownership Registry`, `Bio Entries CRUD`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `PostDetailToolbar()` connect `Waitlist Mutations` to `Inline Image Policy & Constants`?**
