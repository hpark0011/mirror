...
## Summary
- 2136 nodes · 2134 edges · 572 communities (526 shown, 46 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 160 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6c721de0`
...
## Communities (572 total, 46 thin omitted)
...
Cohesion: 0.13
Nodes (17): resolveArticleCoverImageUrl(), validateThumbhashFormat(), collectExternalImageSrcs(), collectExternalImageSrcsRec(), collectInlineImageStorageIds(), extractInlineImageStorageIds(), hasExternalImageSrcs(), isAbsoluteHttpsUrl() (+9 more)
...
Cohesion: 0.23
Nodes (6): CollapsedProfileAvatarButton(), ContentPanelToggle(), ProfileLogo(), ProfilePanel(), useProfileRouteData(), useOptionalWorkspaceChrome()
...
Cohesion: 0.25
Nodes (4): useWorkspaceChrome(), WorkspaceChromeProvider(), BridgeOpenHarness(), ContentToggleHarness()
...
Cohesion: 0.7
Nodes (4): excerptFor(), findRelevantPublishedContent(), isNavigableKind(), normalizeLimit()
