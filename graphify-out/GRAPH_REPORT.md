...
## Corpus Check
- 965 files · ~489,496 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2136 nodes · 2134 edges · 573 communities (527 shown, 46 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 160 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d4cc3087`
...
9. `ensureTestArticleFixtures()` - 12 edges
...
## Communities (573 total, 46 thin omitted)
...
Cohesion: 0.17
Nodes (13): collectExternalImageSrcs(), collectExternalImageSrcsRec(), collectInlineImageStorageIds(), extractInlineImageStorageIds(), hasExternalImageSrcs(), isAbsoluteHttpsUrl(), mapInlineImages(), mapNode() (+5 more)
...
Cohesion: 0.18
Nodes (6): CollapsedProfileAvatarButton(), MirrorLogoMenu(), MirrorLogo(), ProfileLogo(), ProfilePanel(), useProfileRouteData()
...
Cohesion: 0.18
Nodes (6): ContentPanelToggle(), useOptionalWorkspaceChrome(), useWorkspaceChrome(), WorkspaceChromeProvider(), BridgeOpenHarness(), ContentToggleHarness()
...
Cohesion: 0.26
Nodes (8): resolveArticleCoverImageUrl(), validateThumbhashFormat(), resolveStorageUrl(), validateContentStringLength(), getPostCategoryForSlug(), resolvePostCategory(), resolvePostCoverImageUrl(), serializePost()
...
Cohesion: 0.27
Nodes (6): buildRagContext(), excerptFor(), findRelevantPublishedContent(), isNavigableKind(), normalizeLimit(), buildCloneTools()
...
- **Why does `buildProfileSectionHref()` connect `Markdown Import Core` to `Query Test Suites`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `HomePage()` connect `Query Test Suites` to `Markdown Import Core`?**
