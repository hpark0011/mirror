...
## Corpus Check
- 945 files · ~480,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2084 nodes · 2078 edges · 558 communities (515 shown, 43 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 147 edges (avg confidence: 0.8)
...
8. `extractInlineImageStorageIds()` - 11 edges
9. `requireEnv()` - 11 edges
...
## Communities (558 total, 43 thin omitted)
...
Cohesion: 0.05
Nodes (5): ensureTestPostFixtures(), ensureTestArticleFixtures(), waitForAuthReady(), waitForDataState(), requireEnv()
...
Cohesion: 0.1
Nodes (36): analyzeGraphifyEffectiveness(), asObject(), commandFromCall(), defaultLogPaths(), discoverJsonlFiles(), escapeHtml(), findNthReadTime(), inspectGraphHygiene() (+28 more)
...
Cohesion: 0.22
Nodes (9): backfillSlugs(), findFreeSlug(), validateContentStringLength(), filterCallerOwnedInlineIds(), filterUnreferencedStorageIds(), assertValidSlug(), generateSlug(), isValidSlug() (+1 more)
...
Cohesion: 0.24
Nodes (8): collectInlineImageStorageIds(), extractInlineImageStorageIds(), mapInlineImages(), mapNode(), filterVisibleContent(), getUserAndContentAccess(), claimInlineImageOwnership(), rewriteInlineImageSrc()
...
Cohesion: 0.2
Nodes (4): isOwnedByUser(), buildPersonaPatch(), getAppUser(), resolveAvatarUrl()
...
Cohesion: 0.27
Nodes (7): collectExternalImageSrcs(), collectExternalImageSrcsRec(), hasExternalImageSrcs(), isAbsoluteHttpsUrl(), multisetDifference(), nodeHasExternalImageSrc(), importMarkdownInlineImagesCore()
...
- **Why does `useChatSearchParams()` connect `Query Test Suites` to `Cross-Module Helpers & Validators`, `Inline Image Policy & Constants`, `Mutation Test Suites`, `Rick Rubin Seed Helpers`, `Community 60`, `Auth Trigger Tests`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `usePostCoverImageUpload()` connect `Article Markdown Import` to `Beta Allowlist Machinery`?**
