# Graph Report - mirror  (2026-05-09)

## Corpus Check
- 942 files · ~475,574 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2586 nodes · 2958 edges · 683 communities (586 shown, 97 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 149 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `801ca6ce`
...
## Communities (683 total, 97 thin omitted)

### Community 0 - "Chat Streaming + Better Auth (fused)"
Cohesion: 0.05
Nodes (23): ArticlesContentPage(), BioAddEntryButton(), BioEntryForm(), BioEntryFormDialog(), getDefaultValues(), CloneSettingsToolbar(), ContentPanel(), ToolbarSlotProvider() (+15 more)
...
Cohesion: 0.08
Nodes (26): MarkdownViewer(), RichTextEditor(), createArticleEditorExtensions(), createArticleExtensions(), createMarkdownExtensions(), createInlineImageExtension(), collectImageFiles(), createInlineImageUploadExtension() (+18 more)
...
Cohesion: 0.12
Nodes (12): ChatPanel(), InteractionPanel(), ProfileLogo(), ProfilePanel(), PanelFrame(), useConversations(), InteractionDefault(), parseConversationId() (+4 more)
...
Cohesion: 0.16
Nodes (7): ContentBackLink(), MobileWorkspace(), NOOP(), useChatSearchParams(), useProfileWorkspaceRouteData(), getProfileTabHref(), isProfileTabKind()
...
Cohesion: 0.17
Nodes (11): ensureRickRubinPosts(), getPostCategoryForSlug(), resolvePostCategory(), serializePost(), deriveUsernameFromEmail(), ensureRickRubinArticles(), ensureRickRubinConversations(), ensureRickRubinPosts() (+3 more)

### Community 22 - "Bio Embedding Source Tests"
Cohesion: 0.18
Nodes (8): DesktopWorkspace(), WorkspaceShell(), useContentPanelController(), useInteractionPanelController(), usePendingNavigationLatch(), useResizeHandleExpand(), buildGroupRef(), setUpController()
...
Cohesion: 0.19
Nodes (4): Divider(), PageSection(), PeekingBottomDrawer(), noop()
...
- **Why does `useChatSearchParams()` connect `System Prompt Composition` to `Article Markdown Import`, `Rick Rubin Seed Helpers`, `Community 53`, `Waitlist Tests`, `Community 93`?**
