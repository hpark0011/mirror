...
## Corpus Check
- 949 files · ~481,501 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2088 nodes · 2066 edges · 562 communities (519 shown, 43 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 154 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2c5c4b01`
...
## Communities (562 total, 43 thin omitted)
...
Cohesion: 0.05
Nodes (7): createAuthedConvexClient(), readConvexJwtFromStorageState(), ensureTestPostFixtures(), ensureTestArticleFixtures(), waitForAuthReady(), waitForDataState(), requireEnv()
...
Cohesion: 0.05
Nodes (18): BioAddEntryButton(), BioEntryForm(), BioEntryFormDialog(), getDefaultValues(), CloneSettingsToolbar(), ContentPanel(), ToolbarSlotProvider(), ToolbarSlotTarget() (+10 more)
...
Cohesion: 0.15
Nodes (8): useChatSearchParams(), AnimatedArticleRow(), FeaturedArticleCard(), useVisibilityGatedVideoPlayback(), getProfileTabHref(), CloneActionsProvider(), useCloneActions(), thumbhashToDataUrl()

### Community 15 - "Query Test Suites"
Cohesion: 0.19
Nodes (12): collectExternalImageSrcsRec(), collectInlineImageStorageIds(), extractInlineImageStorageIds(), hasExternalImageSrcs(), isAbsoluteHttpsUrl(), mapInlineImages(), mapNode(), nodeHasExternalImageSrc() (+4 more)

### Community 16 - "RAG Embedding Pipeline"
Cohesion: 0.17
Nodes (9): claimCoverBlobOwnershipFromAction(), safeDeleteActionStorage(), setStatusForArticle(), setStatusForPost(), multisetDifference(), isOwnedByUser(), filterCallerOwnedInlineIds(), filterUnreferencedStorageIds() (+1 more)

### Community 17 - "Rick Rubin Seed Mutations"
Cohesion: 0.13
Nodes (8): MirrorLogoMenu(), MirrorLogo(), ProfileLogo(), ProfilePanel(), useConversations(), parseConversationId(), ChatRouteController(), useProfileRouteData()
...
Cohesion: 0.33
Nodes (4): MobileWorkspace(), WorkspaceShell(), useProfileWorkspaceRouteData(), isProfileTabKind()
...
Cohesion: 0.8
Nodes (3): buildBioHref(), buildContentHref(), buildProfileSectionHref()
...
- **Why does `usePostCoverImageUpload()` connect `Slug Backfill & Href Builder` to `Beta Allowlist Machinery`?**
