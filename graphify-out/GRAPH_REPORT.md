# Graph Report - mirror  (2026-05-08)

## Corpus Check
- 917 files · ~406,911 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2503 nodes · 2838 edges · 674 communities (576 shown, 98 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 136 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e53db74a`
...
2. `PageSectionHeader()` - 35 edges
3. `Divider()` - 35 edges
4. `useChatSearchParams()` - 28 edges
5. `useProfileRouteData()` - 21 edges
6. `waitForAuthReady()` - 19 edges
7. `ensureTestArticleFixtures()` - 17 edges
8. `requireEnv()` - 16 edges
9. `WorkspaceToolbar()` - 15 edges
10. `createInlineImageExtension()` - 13 edges
...
## Communities (674 total, 98 thin omitted)
...
Cohesion: 0.07
Nodes (17): ContentEditor(), ContentEditorToolbar(), ContentToolbarShell(), PostEditContentPage(), ArticleEditor(), NewArticleEditor(), PostEditor(), useArticleCoverImageUpload() (+9 more)
...
Cohesion: 0.08
Nodes (11): ArticlesContentPage(), CloneSettingsToolbar(), ContentPanel(), ToolbarSlotProvider(), ToolbarSlotTarget(), WorkspaceToolbar(), PostDetailToolbar(), useCloneSettings() (+3 more)
...
Cohesion: 0.09
Nodes (17): ChatConversationListSheet(), ChatActiveThread(), ChatThread(), ConversationList(), useChatContext(), useAgentIntentWatcher(), useChatMessages(), useChatOptimistic() (+9 more)
...
Cohesion: 0.07
Nodes (3): toReturn(), getLanguageModel(), enforceLimit()
...
Cohesion: 0.15
Nodes (14): collectExternalImageSrcsRec(), collectInlineImageStorageIds(), extractInlineImageStorageIds(), hasExternalImageSrcs(), isAbsoluteHttpsUrl(), mapInlineImages(), mapNode(), multisetDifference() (+6 more)

### Community 17 - "Rick Rubin Seed Mutations"
Cohesion: 0.16
Nodes (9): ContentBackLink(), InteractionPanel(), ProfileLogo(), ProfilePanel(), PanelFrame(), useChatSearchParams(), InteractionDefault(), CloneActionsProvider() (+1 more)
...
Cohesion: 0.17
Nodes (9): CollapsedProfileAvatarButton(), ContentPanelToggle(), DesktopWorkspace(), useContentPanelController(), useInteractionPanelController(), useResizeHandleExpand(), useOptionalWorkspaceChrome(), useWorkspaceChrome() (+1 more)
...
Cohesion: 0.18
Nodes (14): continueThread(), insertOwner(), makeT(), utcMonth(), clearLock(), continueThread(), drainEventLoop(), getErrorData() (+6 more)

### Community 22 - "Bio Embedding Source Tests"
Cohesion: 0.14
Nodes (5): buildRagContext(), buildCloneTools(), buildBioHref(), buildContentHref(), buildProfileSectionHref()
...
Cohesion: 0.19
Nodes (4): PageSectionHeader(), PageSection(), PeekingBottomDrawer(), noop()
...
Cohesion: 0.18
Nodes (5): getContentRouteState(), isContentKind(), isNavigateOutput(), AnimatedArticleRow(), useCloneActions()
...
Cohesion: 0.37
Nodes (7): backfillSlugs(), findFreeSlug(), validateContentStringLength(), assertValidSlug(), generateSlug(), isValidSlug(), rand()
...
Cohesion: 0.17
Nodes (5): ArticleDetail(), PostMetadata(), formatLongDate(), formatShortDate(), thumbhashToDataUrl()
...
Cohesion: 0.27
Nodes (7): resolveArticleCoverImageUrl(), validateThumbhashFormat(), filterVisibleContent(), getUserAndContentAccess(), resolveStorageUrl(), resolvePostCoverImageUrl(), serializePost()
...
Cohesion: 0.5
Nodes (4): MobileWorkspace(), NOOP(), WorkspaceShell(), useProfileWorkspaceRouteData()
...
- **Why does `WorkspaceToolbar()` connect `Bio Entries CRUD` to `Body Walk & Ownership Registry`, `Clone Tool Definitions & Tests`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `useChatSearchParams()` connect `Rick Rubin Seed Mutations` to `Inline Image Policy & Constants`, `Inline Image URL Helpers`, `Bio Entries CRUD`, `Email Send Actions (transport)`, `Community 76`, `Community 59`, `Auth Trigger Tests`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `uploadToStorage()` connect `Body Walk & Ownership Registry` to `SafeFetch SSRF Defenses`?**
