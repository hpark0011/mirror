# Graph Report - improvements-chat-thread-ui  (2026-05-10)

## Corpus Check
- 963 files · ~474,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2128 nodes · 2119 edges · 573 communities (524 shown, 49 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 159 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb3de62d`
...
## Communities (573 total, 49 thin omitted)
...
Cohesion: 0.14
Nodes (10): ChatPanel(), InteractionPanel(), ProfileLogo(), ProfilePanel(), useChatSearchParams(), useConversations(), parseConversationId(), ChatRouteController() (+2 more)
...
- **Why does `buildProfileSectionHref()` connect `Inline Image URL Helpers` to `Query Test Suites`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `HomePage()` connect `Query Test Suites` to `Inline Image URL Helpers`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
