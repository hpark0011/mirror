# Graph Report - mirror  (2026-05-07)

## Corpus Check
- 905 files · ~386,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2764 nodes · 3226 edges · 701 communities (418 shown, 283 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12f6ddd0`
...
1. `PageSection()` - 36 edges
2. `PageSectionHeader()` - 36 edges
3. `Divider()` - 36 edges
4. `useChatSearchParams()` - 30 edges
5. `useProfileRouteData()` - 23 edges
6. `waitForAuthReady()` - 19 edges
7. `extractInlineImageStorageIds()` - 17 edges
8. `ensureTestArticleFixtures()` - 17 edges
9. `WorkspaceToolbar()` - 16 edges
10. `requireEnv()` - 16 edges

## Surprising Connections (you probably didn't know these)
- `ensureRickRubinPosts()` --calls--> `getPostCategoryForSlug()`  [INFERRED]
  packages/convex/convex/seed.ts → /Users/disquiet/Desktop/mirror/.worktrees/refactor-post-files/packages/convex/convex/posts/categories.ts
- `generateMetadata()` --calls--> `isReservedUsername()`  [INFERRED]
  apps/mirror/app/[username]/layout.tsx → /Users/disquiet/Desktop/mirror/.worktrees/refactor-post-files/apps/mirror/lib/reserved-usernames.ts
- `ProfileLayout()` --calls--> `enforceOnboardingGate()`  [INFERRED]
  apps/mirror/app/[username]/layout.tsx → /Users/disquiet/Desktop/mirror/.worktrees/refactor-post-files/apps/mirror/lib/route-guards.ts
- `useProfileWorkspaceRouteData()` --calls--> `getContentRouteState()`  [INFERRED]
  /Users/disquiet/Desktop/mirror/.worktrees/refactor-post-files/apps/mirror/app/[username]/_hooks/use-profile-workspace-route-data.ts → apps/mirror/features/content/types.ts
- `PostDetailToolbar()` --calls--> `useChatSearchParams()`  [INFERRED]
  apps/mirror/features/posts/components/detail/post-detail-toolbar.tsx → /Users/disquiet/Desktop/mirror/.worktrees/refactor-post-files/apps/mirror/hooks/use-chat-search-params.ts

## Communities (701 total, 283 thin omitted)
...
Cohesion: 0.06
Nodes (18): writeTempWebp(), writeTempGif(), writeTempPng(), pastePng(), writeTempOversizePng(), ensureTestPostFixtures(), writeTempBlob(), writeTempMd() (+10 more)

### Community 2 - "Inline Image Policy & Constants"
Cohesion: 0.05
Nodes (17): AvatarImageSurface(), AvatarWindow(), ProfileMedia(), ArticleWorkspaceProvider(), getPostSearchableFields(), PostWorkspaceProvider(), useIsProfileOwner(), PublishToggleConnector() (+9 more)

### Community 3 - "Body Walk & Ownership Registry"
Cohesion: 0.08
Nodes (21): ContentPanel(), EmptyMessage(), ToolbarSlotProvider(), ToolbarSlotTarget(), useArticleList(), usePostList(), useScrollRoot(), usePendingNavigationLatch() (+13 more)

### Community 4 - "Beta Allowlist Machinery"
Cohesion: 0.07
Nodes (23): ChatConversationListSheet(), ChatActiveThread(), ChatThread(), cn(), ConversationList(), ConversationListItemTimestamp(), getContentRouteState(), isContentKind() (+15 more)

### Community 5 - "Bio Entries CRUD"
Cohesion: 0.07
Nodes (14): getAuthErrorMessage(), LoginBlock(), SignUpBlock(), MagicLinkLoginForm(), MagicLinkSignUpForm(), OTPLoginForm(), OTPSignUpForm(), useMagicLinkRequest() (+6 more)

### Community 6 - "Better Auth Triggers & Plugins"
Cohesion: 0.08
Nodes (19): buildRagContext(), buildCloneTools(), buildBioHref(), buildContentHref(), buildProfileSectionHref(), continueThread(), insertOwner(), makeT() (+11 more)
...
Cohesion: 0.11
Nodes (14): ContentBackLink(), ChatPanel(), InteractionPanel(), ProfileLogo(), ProfilePanel(), PanelFrame(), useChatSearchParams(), useConversations() (+6 more)

### Community 9 - "SafeFetch SSRF Defenses"
Cohesion: 0.07
Nodes (4): chunkText(), extractPlainText(), buildPersonaPatch(), resolveAvatarUrl()

### Community 10 - "Generated API Surface"
Cohesion: 0.11
Nodes (12): usePostToolbar(), useCoverImageState(), useCreatePostFromFile(), useMarkdownFileParser(), usePostCoverImageUpload(), MarkdownUploadDialogConnector(), PostListToolbarConnector(), markdownToJsonContent() (+4 more)
...
Cohesion: 0.07
Nodes (4): toReturn(), getLanguageModel(), enforceLimit(), validateEnv()

### Community 13 - "Article Markdown Import"
Cohesion: 0.18
Nodes (10): resolveArticleCoverImageUrl(), extractInlineImageStorageIds(), mapInlineImages(), filterVisibleContent(), getUserAndContentAccess(), resolveStorageUrl(), claimInlineImageOwnership(), resolvePostCoverImageUrl() (+2 more)

### Community 14 - "Playwright Test-Mode Gates"
Cohesion: 0.21
Nodes (13): validateDateRange(), validateString(), backfillSlugs(), findFreeSlug(), multisetDifference(), isOwnedByUser(), validateContentStringLength(), filterCallerOwnedInlineIds() (+5 more)

### Community 15 - "Query Test Suites"
Cohesion: 0.15
Nodes (11): getChatStateTracking(), getScrollMetrics(), installChatStateTracking(), resetChatStateTracking(), scrollChatUp(), waitForAssistantText(), waitForScrollGrowth(), assertNoMarkdown() (+3 more)
...
Cohesion: 0.2
Nodes (9): DesktopWorkspace(), MobileWorkspace(), NOOP(), WorkspaceShell(), useContentPanelController(), useInteractionPanelController(), useProfileWorkspaceRouteData(), useResizeHandleExpand() (+1 more)
...
Cohesion: 0.18
Nodes (7): VideoCallContent(), Conversation(), CVIProvider(), callReducer(), useCallState(), endTavusConversation(), useVideoCall()

### Community 20 - "Rick Rubin Seed Helpers"
Cohesion: 0.26
Nodes (8): createAuth(), runSendVerificationOtpGate(), getPlaywrightTestSecret(), isPlaywrightTestEmail(), isPlaywrightTestMode(), authorizeTestRequest(), secretsMatch(), assertTestEmail()

### Community 21 - "Orphan Sweep Tests"
Cohesion: 0.17
Nodes (6): ContentEditor(), ContentEditorToolbar(), ContentToolbarShell(), PostEditContentPage(), PostEditor(), usePostInlineImageUpload()
...
Cohesion: 0.18
Nodes (5): ChatHeaderAction(), ChatHeaderProfileName(), CollapsedProfileAvatarButton(), MirrorAvatar(), getProfileInitials()
...
Cohesion: 0.21
Nodes (7): ArticleEditor(), NewArticleEditor(), useArticleCoverImageUpload(), useArticleInlineImageUpload(), useEditArticleForm(), useNewArticleForm(), NewArticleContentPage()

### Community 26 - "Convex App Registry"
Cohesion: 0.17
Nodes (5): ArticlesContentPage(), WorkspaceToolbar(), PostDetailConnector(), PostDetailToolbar(), PostsContentPage()

### Community 27 - "Waitlist Tests"
Cohesion: 0.28
Nodes (9): blobExists(), bodyWithImages(), extractInlineIdsFromBody(), imageNode(), insertAppUserAndSignIn(), makeT(), normalizeConvexGlob(), SafeFetchError (+1 more)

### Community 28 - "OTP Send Tests"
Cohesion: 0.25
Nodes (12): allocatePort(), explicitPort(), git(), hashOffset(), lockPath(), mainRoot(), readRegistry(), registryPath() (+4 more)

### Community 29 - "Allowlist Tests"
Cohesion: 0.2
Nodes (6): onSelectionUpdate(), shouldShowTextMenu(), applyTextStyle(), getActiveTextStyle(), TextStylePicker(), ToolbarSeparator()

### Community 30 - "Auth Trigger Tests"
Cohesion: 0.19
Nodes (6): AppDock(), AppDockContent(), useDockConfig(), useDockVisibility(), DockProvider(), useDock()

### Community 31 - "Email Templates"
Cohesion: 0.19
Nodes (8): collectExternalImageSrcs(), collectExternalImageSrcsRec(), collectInlineImageStorageIds(), hasExternalImageSrcs(), isAbsoluteHttpsUrl(), mapNode(), nodeHasExternalImageSrc(), importMarkdownInlineImagesCore()
...
Cohesion: 0.23
Nodes (3): InlineImageValidationError, validateInlineImageFile(), uploadToStorage()
...
Cohesion: 0.19
Nodes (4): PageSection(), noop(), SignUpView(), SignUpPage()
...
Cohesion: 0.21
Nodes (4): ContentPanelToggle(), useOptionalWorkspaceChrome(), useWorkspaceChrome(), ContentToggleHarness()
...
Cohesion: 0.18
Nodes (4): ArticleDetail(), PostMetadata(), formatLongDate(), formatShortDate()

### Community 43 - "Community 43"
Cohesion: 0.27
Nodes (5): onSubmit(), useUsernameAvailability(), isReservedUsername(), generateMetadata(), ProfileLayout()
...
Cohesion: 0.25
Nodes (3): MirrorLogoMenu(), MirrorLogo(), WaitlistLanding()
...
Cohesion: 0.27
Nodes (3): ensureRickRubinPosts(), getPostCategoryForSlug(), resolvePostCategory()
...
Cohesion: 0.31
Nodes (3): filterUnreferencedStorageIds(), buildReferencedStorageSet(), collectReferencedFromCandidates()
...
Cohesion: 0.44
Nodes (7): ChatMessageEmptyState(), ChatMessageLoadingMore(), ChatMessageLoadingState(), ChatMessageScrollArea(), getDistanceFromBottom(), handleScroll(), isNearBottom()
...
Cohesion: 0.28
Nodes (3): BioAddEntryButton(), BioEntryFormDialog(), useBioPanelHandlers()

### Community 74 - "Community 74"
Cohesion: 0.31
Nodes (3): BioEntryForm(), getDefaultValues(), epochMsToMonthYear()
...
Cohesion: 0.46
Nodes (6): blobExists(), findSchemaStorageRefs(), makeT(), normalizeConvexGlob(), storeBlob(), walkConvexFiles()

### Community 80 - "Community 80"
Cohesion: 0.36
Nodes (4): filterContent(), getUniqueContentCategories(), sortContent(), getDateRange()
...
Cohesion: 0.48
Nodes (5): getPost(), insertPost(), insertUser(), makeT(), normalizeConvexGlob()
...
Cohesion: 0.6
Nodes (3): ensureBioFixtures(), monthEpoch(), waitForAuthReady()
...
- **Why does `useChatSearchParams()` connect `Articles CRUD` to `Community 70`, `Community 42`, `Rick Rubin Seed Mutations`, `Community 87`, `Convex App Registry`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `WorkspaceToolbar()` connect `Convex App Registry` to `Community 81`, `Community 73`, `Body Walk & Ownership Registry`, `Orphan Sweep Tests`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `PostDetailToolbar()` connect `Convex App Registry` to `Articles CRUD`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Are the 8 inferred relationships involving `useChatSearchParams()` (e.g. with `MobileWorkspace()` and `ProfilePanel()`) actually correct?**
  _`useChatSearchParams()` has 8 INFERRED edges - model-reasoned connections that need verification._
