...
| AGENTS.md (mirror) | Current | Onboarding features added |
...
- New package added to `packages/`
- New feature added to any app's `features/`
- New route group added to any app's `app/`
- New tooling config added to `tooling/`
