...
Pick which specialist reviewer agents to spawn. Eleven specialists live in `.Codex/agents/code-review/` — five run on every review, six are routed by the risk map from Phase 2.
