...
`new-worktree.sh` is fully non-interactive and runs end-to-end. On success the worktree is immediately usable.
...
- Why this matters: see `.agents/rules/worktrees.md` § Fresh Worktree.
