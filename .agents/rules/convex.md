...
For a canonical end-to-end walkthrough (chat app with schema, queries, mutations, actions, scheduling, AI integration), see `docs/conventions/convex-reference-chat-app.md`.
