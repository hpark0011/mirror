...
export const ArticleListItem = memo(function ArticleListItem({
  ...
  return (
    <AnimatedArticleRow
      ...
      index={index}
      className="relative border-b-0 group-hover/list:text-muted-foreground hover:text-secondary-foreground min-h-[44px]"
    ...
    >
      ...
      <TableCell
        className={cn(
          "font-normal truncate max-w-0 py-0 text-lg pl-6",
          isOwner && "pl-0",
        )}
      >
        <Link
      ...
      <TableCell className="hidden md:table-cell py-0 font-normal">
        {article.category}
      </TableCell>
