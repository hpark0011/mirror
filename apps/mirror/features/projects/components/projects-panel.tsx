...
import { MAX_PROJECTS } from "../hooks/use-projects";
import { useProjectsPanelHandlers } from "../hooks/use-projects-panel-handlers";
...
export function ProjectsPanel() {
  ...
  const addDisabledReason = addDisabled
    ? `Project limit reached (${MAX_PROJECTS}). Delete a project to add another.`
    : undefined;
  ...
  return (
    <>
      ...
      >
        {projects.length !== 0 ? (
          <p className="text-[15px] mb-4">Projects and recent work.</p>
        ) : null}
