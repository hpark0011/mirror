...
describe("ChatRouteController — pendingNewConversationId bridge", () => {
  ...
  it("auto-selects the latest public conversation when chat opens without a conversation id", () => {
    let latest: Captured | null = null;
    mockConversations = [
  ...
  it("public chat + conversationsLoading=true + no conversations still returns resolving", () => {
    let latest: Captured | null = null;
