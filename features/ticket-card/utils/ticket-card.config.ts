...
export const statusStyles: Record<ColumnId, string> = {
  ...
  complete:
    "bg-white/80 dark:bg-card border-white/30 dark:border-white/2 bg-[image:repeating-linear-gradient(315deg,_var(--pattern-fg)_0,_var(--pattern-fg)_1px,_transparent_0,_transparent_50%)] bg-[size:10px_10px] bg-fixed [--pattern-fg:var(--color-black)]/5 dark:[--pattern-fg:var(--color-white)]/5",
};
