...
name: config-audit
description: >
  Audit Claude Code configuration files (AGENTS.md, CLAUDE.md, .claude/rules/,
  .claude/skills/) against actual codebase patterns. Identifies stale rules,
  ...
  "are my rules correct", or "clean up CLAUDE.md".
disable-model-invocation: true
---

## Audit Procedure

1. Read all config files: AGENTS.md, CLAUDE.md, .claude/rules/_, .claude/skills/_/SKILL.md, .claude/agents/\*
...
4. Audit AGENTS.md / CLAUDE.md against the lean-index philosophy:
...
5. Check rule budget:
   ...
   - Are there rules Claude follows correctly without being told? (Often: generic best practices that aren't repo-specific — drop them.)
