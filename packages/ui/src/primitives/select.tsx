  ...
  ),
  {
    variants: {
      variant: {
        default: cn(
          "border border-input",
          "rounded-md px-2.5 data-[size=sm]:rounded-[7px] data-[size=sm]:px-2 data-[size=sm]:pr-1.5 [corner-shape:superellipse(1.2)]",
          "focus-visible:border-ring focus-visible:ring-ring focus-visible:ring-[2px]",
        ),
        underline: cn(
          "border-b border-input",
          "rounded-none rounded-t-md px-1.5",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-gray-4 focus:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-[7px] py-1 pr-8 pl-2 text-[13px] outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
      ...
      >
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-3.5 text-information" />
        </SelectPrimitive.ItemIndicator>
      </span>
